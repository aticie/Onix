...
tf.app.flags.DEFINE_string('data_directory', '/home/huseyin/Datasets_HMR/3dhp/mpi_inf_3dhp',
                           'data directory: top of mpi-inf-3dhp')
tf.app.flags.DEFINE_string('output_directory',
                           '/home/huseyin/TF_Onix/MPI_INF_3DHP/',
...
def process_mpi_inf_3dhp_train(data_dir, out_dir, is_train=False):
    ...
    out_path = join(out_dir, 'train_%04d.tfrecords')
