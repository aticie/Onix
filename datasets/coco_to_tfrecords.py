...
tf.app.flags.DEFINE_string('data_directory', '/home/huseyin/Datasets/COCO/',
                           'data directory: top of coco')
tf.app.flags.DEFINE_string('output_directory',
                           '/home/huseyin/TF_Onix/COCO/',
...
def process_coco(data_dir, out_dir, num_shards, is_train=True):
    ...
    if is_train:
        data_type = 'train2017' #         data_type = 'train2014'
        out_path = join(out_dir, 'train_%04d_wmeta.tfrecord')
    else:
        data_type = 'val2017' #        data_type = 'val2014'
