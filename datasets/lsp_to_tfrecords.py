...
if Extended:
	tf.app.flags.DEFINE_string('img_directory',
		                   '/home/huseyin/Data_try/LSP_Extended/',
		                   'image data directory')
	tf.app.flags.DEFINE_string(
	    'output_directory', '/home/huseyin/TF_Onix/LSP_Extended/',
	    'Output data directory')
else:

	tf.app.flags.DEFINE_string('img_directory',
		                   '/home/huseyin/Data_try/LSP/',
		                   'image data directory')
	tf.app.flags.DEFINE_string(
	    'output_directory', '/home/huseyin/TF_Onix/LSP/',
	    'Output data directory')
